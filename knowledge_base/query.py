...
queryFour = g.query("""
                    ...
                    WHERE {
                        focudata:Gursimran focu:graded_courses ?course .
...
queryFive = g.query("""
                    ...
                    SELECT ?studentName
                    WHERE {
                         <http://focu.io/data#http://dbpedia.org/resource/Transmission_Control_Protocol> focu:containInverse ?course .
...
print()
print()
print('For a given topic, list all students that are familiar with the topic (i.e., took, and did not fail, a course that covered the topic)')
print()
print('Student names: ')
print()
...
querySix = g.query("""
                    ...
                    WHERE {
                      focudata:Gursimran focu:graded_courses ?courseNameWithID .
